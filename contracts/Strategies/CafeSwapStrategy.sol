...
contract CafeSwapStrategy is Ownable, ReentrancyGuard {
    ...
    IMasterChef public masterChefContract; //MasterChef contract of Cafeswap (polygon)
    ...
    /**
     * @notice Creates a new CafeSwap Strategy Contract
     * @param _asset same which is used in masterChefContract
    ...
    /**
     * @notice Updates the MasterChef Contract used by CafeSwap
    ...
    /**
     * @notice Updates the CafeSwap LP Token Address.
     * @param _asset Address of the CafeSwap LP
     * @dev Only owner can call and update the CafeSwap LP address
     */
    ...
    /**
     * @dev View function to see pending rewards by Cafeswap MasterChef Contracts.
     */
    function getStakingRewards() public view returns (uint256 pendingRewards) {
        pendingRewards = masterChefContract.pendingBrew(pid, address(this));
    }
    ...
    /**
     * @notice function to deposit asset to CafeSwap farms.
    ...
    /**
     * @dev function to deposit asset from strategy to CafeSwap MasterChef Contract.
     */
    ...
    /**
     * @notice function to withdraw asset from CafeSwap farms.
     * @param _token Address of the token. (Should be the same as the asset token)
    ...
    /**
     * @dev function to withdraw asset from CafeSwap Staking Contract to strategy
     */
